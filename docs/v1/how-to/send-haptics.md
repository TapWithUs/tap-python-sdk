...
- Requires an active BLE connection (`await tap.start()` or `await tap.run()` first).
...
Runnable sample: [`examples/basic.py`](https://github.com/TapWithUs/tap-python-sdk/blob/v2/examples/basic.py).
